...
class Imaginemcore_Demo_Importer {
	...
	function ocdi_plugin_intro_text( $default_text ) {
	    $default_text .= '<div class="ocdi__intro-text"><p><h3>Welcome to our Blacksilver Demo Importer</h3>Let us know through our <strong><a target="_blank" href="http://support.imaginemthemes.co/">Support Forum</a></strong> if you have trouble importing the demo.</p><p>You can <strong><a href="http://support.imaginemthemes.co/wp-login.php?action=register">Register to support forum</a></strong> then create a <strong><a href="http://support.imaginemthemes.co/forums/forum/blacksilver-photography-theme/">New Support Thread here</a></strong></p><br/><br/><br/></div>';
	...
	public function import_files() {
		return array(
			...
			array(
				...
				'import_notice'              => __( 'This process will import <strong>OnePage Demo</strong>.<br/><br/>If the demo import is not successful then it is likely due to server settings. Let us know through our <a style="box-shadow: none !important;" target="_blank" href="http://support.imaginemthemes.co/">Support Forum</a> for us to help.', 'themecore' ),
				'preview_url'                => '',
			),
			array(
				...
				'import_notice'              => __( 'This process will import <strong>Ceres Demo</strong>.<br/><br/>If the demo import is not successful then it is likely due to server settings. Let us know through our <a style="box-shadow: none !important;" target="_blank" href="http://support.imaginemthemes.co/">Support Forum</a> for us to help.', 'themecore' ),
				'preview_url'                => '',
			),
			array(
