	...
	function init()
	{
		...
		*/
	    ...
	    if (function_exists('blacksilver_get_option_data')) {
	    	$mtheme_portfolio_slug = blacksilver_get_option_data('portfolio_permalink_slug');
		}
	    ...
	    if (function_exists('blacksilver_get_option_data')) {
	    	$mtheme_portfolio_singular_refer = blacksilver_get_option_data('portfolio_archive_title');
		}
		...
		*/
		register_taxonomy("types", array("portfolio"), array("hierarchical" => true, "label" => "Work Type", "singular_label" => "Types", "rewrite" => true));
