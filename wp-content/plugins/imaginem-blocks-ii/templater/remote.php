...
class iMaginem_Templates_Remote extends Elementor\TemplateLibrary\Source_Base {
	...
	public function get_items( $args = [] ) {
		...
		$templates_data = array(
			1 	=> array(
				...
				'thumbnail' => 'https://blacksilver.imaginem.co/imaginem-templates/blacksilver/screenshots/template-1.png',
				'date' => date( get_option( 'date_format' ), $today ),
				'author' => 'iMaginem',
				'tags' => array('imaginem'),
				'isPro' => false,
				'hasPageSettings' => false,
				'url' => 'https://blacksilver.imaginem.co/about-me/',
			),
			2 	=> array(
				...
				'thumbnail' => 'https://blacksilver.imaginem.co/imaginem-templates/blacksilver/screenshots/template-2.png',
				'date' => date( get_option( 'date_format' ), $today ),
				'author' => 'iMaginem',
				'tags' => array('imaginem'),
				'isPro' => false,
				'hasPageSettings' => false,
				'url' => 'https://blacksilver.imaginem.co/about-me-ii/',
			),
			3 	=> array(
				...
				'thumbnail' => 'https://blacksilver.imaginem.co/imaginem-templates/blacksilver/screenshots/template-3.png',
				'date' => date( get_option( 'date_format' ), $today ),
				'author' => 'iMaginem',
				'tags' => array('imaginem'),
				'isPro' => false,
				'hasPageSettings' => false,
				'url' => 'https://blacksilver.imaginem.co/about-me-iii/',
			),
			4 	=> array(
				...
				'thumbnail' => 'https://blacksilver.imaginem.co/imaginem-templates/blacksilver/screenshots/template-4.png',
				'date' => date( get_option( 'date_format' ), $today ),
				'author' => 'iMaginem',
				'tags' => array('imaginem'),
				'isPro' => false,
				'hasPageSettings' => false,
				'url' => 'https://blacksilver.imaginem.co/about-me-iv/',
			),
			5 	=> array(
				...
				'thumbnail' => 'https://blacksilver.imaginem.co/imaginem-templates/blacksilver/screenshots/template-5.png',
				'date' => date( get_option( 'date_format' ), $today ),
				'author' => 'iMaginem',
				'tags' => array('imaginem'),
				'isPro' => false,
				'hasPageSettings' => false,
				'url' => 'https://blacksilver.imaginem.co/about-us/',
			),
			6 	=> array(
				...
				'subtype' => 'page',
				'title' => 'Blacksilver - About Us',
				'thumbnail' => 'https://blacksilver.imaginem.co/imaginem-templates/blacksilver/screenshots/template-6.png',
				'date' => date( get_option( 'date_format' ), $today ),
				'author' => 'iMaginem',
				'tags' => array('imaginem'),
				'isPro' => false,
				'hasPageSettings' => false,
				'url' => 'https://blacksilver.imaginem.co/about-us-ii/',
			),
			7 	=> array(
				...
				'thumbnail' => 'https://blacksilver.imaginem.co/imaginem-templates/blacksilver/screenshots/template-7.png',
				'date' => date( get_option( 'date_format' ), $today ),
				'author' => 'iMaginem',
				'tags' => array('imaginem'),
				'isPro' => false,
				'hasPageSettings' => false,
				'url' => 'https://blacksilver.imaginem.co/blog-grid/',
			),
			8 	=> array(
				...
				'thumbnail' => 'https://blacksilver.imaginem.co/imaginem-templates/blacksilver/screenshots/template-8.png',
				'date' => date( get_option( 'date_format' ), $today ),
				'author' => 'iMaginem',
				'tags' => array('imaginem'),
				'isPro' => false,
				'hasPageSettings' => false,
				'url' => 'https://blacksilver.imaginem.co/blog-list/',
			),
			9 	=> array(
				...
				'thumbnail' => 'https://blacksilver.imaginem.co/imaginem-templates/blacksilver/screenshots/template-9.png',
				'date' => date( get_option( 'date_format' ), $today ),
				'author' => 'iMaginem',
				'tags' => array('imaginem'),
				'isPro' => false,
				'hasPageSettings' => false,
				'url' => 'https://blacksilver.imaginem.co/blog-parallax/',
			),
			10 	=> array(
				...
				'thumbnail' => 'https://blacksilver.imaginem.co/imaginem-templates/blacksilver/screenshots/template-10.png',
				'date' => date( get_option( 'date_format' ), $today ),
				'author' => 'iMaginem',
				'tags' => array('imaginem'),
				'isPro' => false,
				'hasPageSettings' => false,
				'url' => 'https://blacksilver.imaginem.co/blog-small/',
			),
			11 	=> array(
				...
				'thumbnail' => 'https://blacksilver.imaginem.co/imaginem-templates/blacksilver/screenshots/template-11.png',
				'date' => date( get_option( 'date_format' ), $today ),
				'author' => 'iMaginem',
				'tags' => array('imaginem'),
				'isPro' => false,
				'hasPageSettings' => false,
				'url' => 'https://blacksilver.imaginem.co/contact-us/',
			),
			12 	=> array(
				...
				'thumbnail' => 'https://blacksilver.imaginem.co/imaginem-templates/blacksilver/screenshots/template-12.png',
				'date' => date( get_option( 'date_format' ), $today ),
				'author' => 'iMaginem',
				'tags' => array('imaginem'),
				'isPro' => false,
				'hasPageSettings' => false,
				'url' => 'https://blacksilver.imaginem.co/contact-us-ii/',
			),
			13 	=> array(
				...
				'thumbnail' => 'https://blacksilver.imaginem.co/imaginem-templates/blacksilver/screenshots/template-13.png',
				'date' => date( get_option( 'date_format' ), $today ),
				'author' => 'iMaginem',
				'tags' => array('imaginem'),
				'isPro' => false,
				'hasPageSettings' => false,
				'url' => 'https://blacksilver.imaginem.co/event-gallery-i/',
			),
			14 	=> array(
				...
				'thumbnail' => 'https://blacksilver.imaginem.co/imaginem-templates/blacksilver/screenshots/template-14.png',
				'date' => date( get_option( 'date_format' ), $today ),
				'author' => 'iMaginem',
				'tags' => array('imaginem'),
				'isPro' => false,
				'hasPageSettings' => false,
				'url' => 'https://blacksilver.imaginem.co/our-services/',
			),
			15 	=> array(
				...
				'thumbnail' => 'https://blacksilver.imaginem.co/imaginem-templates/blacksilver/screenshots/template-15.png',
				'date' => date( get_option( 'date_format' ), $today ),
				'author' => 'iMaginem',
				'tags' => array('imaginem'),
				'isPro' => false,
				'hasPageSettings' => false,
				'url' => 'https://blacksilver.imaginem.co/our-services-ii/',
			),
			16 	=> array(
				...
				'type' => 'page',
				'subtype' => 'page',
				'title' => 'Blacksilver - Portfolio',
				'thumbnail' => 'https://blacksilver.imaginem.co/imaginem-templates/blacksilver/screenshots/template-16.png',
				'date' => date( get_option( 'date_format' ), $today ),
				'author' => 'iMaginem',
				'tags' => array('imaginem'),
				'isPro' => false,
				'hasPageSettings' => false,
				'url' => 'https://blacksilver.imaginem.co/portfolio-items/portfolio-classic-3-column/',
			),
			17 	=> array(
				...
				'type' => 'page',
				'subtype' => 'page',
				'title' => 'Blacksilver - Gallery',
				'thumbnail' => 'https://blacksilver.imaginem.co/imaginem-templates/blacksilver/screenshots/template-17.png',
				'date' => date( get_option( 'date_format' ), $today ),
				'author' => 'iMaginem',
				'tags' => array('imaginem'),
				'isPro' => false,
	...
	public function get_data( array $args, $context = 'display' ) {
		$url	  = 'https://blacksilver.imaginem.co/imaginem-templates/blacksilver/data/'.$args['template_id'].'.json';
