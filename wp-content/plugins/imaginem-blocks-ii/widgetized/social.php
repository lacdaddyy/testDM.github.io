...
class mtheme_Social_Widget extends WP_Widget {
	function __construct() {
		...
		parent::__construct( 'msocial-widget', __('blacksilver Social Widget', 'mthemelocal'), $widget_ops,$control_ops);
	}
...
<!-- Open in new tab: Dropdown -->
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'address' ); ?>"><?php _e('Address:', 'mthemelocal'); ?></label><br />
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id( 'custom'.$social_count.'name' ); ?>"><?php echo $defaults['custom'.$social_count.'name']; ?>:</strong> <?php echo $the_label; ?></label><br />
