...
class mTheme_Widget_Flickr extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct('flickr', __('blacksilver Flickr', 'mthemelocal'), $widget_ops);
	}
...
function mTheme_Widget_Flickr_register_widgets() {
	register_widget( 'mTheme_Widget_Flickr' );
}
add_action( 'widgets_init', 'mTheme_Widget_Flickr_register_widgets' );
?>