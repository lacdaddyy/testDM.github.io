    ...
    public function widget ( $args, $instance ){
       ...
       if($show_playlist) {
        ...
        if(Sonaar_Music::get_option('show_artist_name') ){
            $artistSeparator = (Sonaar_Music::get_option('artist_separator') || Sonaar_Music::get_option('artist_separator') != '')?Sonaar_Music::get_option('artist_separator'): __('by', 'sonaar-music');
        ...
        : '').'
        <div class="playlist">
            <h3 class="sr_it-playlist-title">'. get_the_title($firstAlbum) .'</h3>
